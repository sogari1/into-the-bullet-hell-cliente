...
public class SonidoRuta {
	...
	//DISPAROS ARMAS
	public static final EfectoSonido DISPARO_PISTOLA = new EfectoSonido("sonidos/armas/Pistola.wav");
	public static final EfectoSonido DISPARO_ESCOPETA = new EfectoSonido("sonidos/armas/Escopeta.wav");
	public static final EfectoSonido DISPARO_BFG9000 = new EfectoSonido("sonidos/armas/BFG.wav");
	public static final EfectoSonido DISPARO_ESTRELLA = new EfectoSonido("sonidos/armas/EstrellaNinja.wav");
	public static final EfectoSonido DISPARO_SNIPER = new EfectoSonido("sonidos/armas/Sniper.wav");
	public static final EfectoSonido DISPARO_AWP = new EfectoSonido("sonidos/armas/Awp.wav");
	public static final EfectoSonido DISPARO_BLASTER = new EfectoSonido("sonidos/armas/Blaster.wav");
